...
volatile u32* intc1_ier_addr = (u32*)(XPAR_AXI_INTC_1_BASEADDR + 0x8);
volatile u32* intc1_iar_addr = (u32*)(XPAR_AXI_INTC_1_BASEADDR + 0xC);
volatile u32* intc1_ivr_addr = (u32*)(XPAR_AXI_INTC_1_BASEADDR + 0x18);
volatile u32* intc1_mer_addr = (u32*)(XPAR_AXI_INTC_1_BASEADDR + 0x1C);
...
// Clear the pending interrupt
    *intc1_iar_addr |= (1 << XPAR_AXI_INTC_0_SW_1_INTR);
...
// Set interrupt controller: enable Sw1 interrupts
    *intc1_ier_addr |= (1 << XPAR_AXI_INTC_0_SW_1_INTR);
    *intc1_mer_addr = 0x3;
// Enable microblaze interrupt
    ...
    while (1) {
        if (interrupt_flag) {
            ...
            // send interrupt to core 2
			*intc2_isr_addr |= (1 << XPAR_AXI_INTC_0_SW_2_INTR);
